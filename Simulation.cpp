...
Simulation::Simulation() : rng_(std::random_device{}()) {
    ...
    static const InvParams inv_params[5] = {
        ...
        {300,    {0.05, 0.30, 0.30, 0.05, 0.05, 0.05, 0.05, 0.05, 0.05, 0.05}},
        {1000,   {0.05, 0.05, 0.05, 0.05, 0.40, 0.20, 0.05, 0.05, 0.05, 0.05}},
        {3000,   {0.05, 0.05, 0.05, 0.05, 0.05, 0.05, 0.25, 0.25, 0.10, 0.10}},
        {100000, {0.10, 0.10, 0.10, 0.10, 0.10, 0.10, 0.10, 0.10, 0.10, 0.10}},
    };
